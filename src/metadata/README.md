 ...
 * [aopo.yml](aopo.yml)
     * Determines how your purl.obolibrary.org/obo/aopo/ redirects will be handled
     ...
     * Paste in the contents of [aopo.yml](aopo.yml)
 ...
 * [aopo.md](aopo.md)
     ...
     * Paste in the contents of [aopo.md](aopo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
